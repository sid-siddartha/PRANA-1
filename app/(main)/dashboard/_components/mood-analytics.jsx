...
import { HeartPulse, ChevronsRight, ArrowRight } from "lucide-react";
      ...
      {analytics.data.entries.length === 0 ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              <Link href="/questions">
                <Card className="bg-gradient-to-r from-purple-700 to-purple-500 shadow-lg
                   hover:shadow-xl transition-all rounded-xl shadow-lg cursor-pointer">
                  ...
                  <CardContent className="flex flex-col items-start gap-3">
                    <p className="text-white text-lg">
                      Assess your current well-being through a short series of
                      questions.
                    </p>
                    <div className="flex items-center gap-2 mt-2 text-white text-lg font-semibold hover:text-gray-200">
                      <span className="text-xl">Start Now</span>
